...
export const FaleComigo = () => {
    return (
        <div className="flex flex-col items-center justify-center xl:flex-row p-4 sm:p-12 text-center xl:text-left">
            ...
            <div className="w-5/6 xl:w-3/6 p-2 text-center bg-creme1/50 rounded-b-[32rem] rounded-t-full">
                <img
