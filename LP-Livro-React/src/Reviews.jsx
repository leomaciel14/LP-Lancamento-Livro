...
const Reviews = () => {
    ...
    return (
        <div className="p-6">
            ...
            <ul className="grid items-center justify-center m-auto grid-cols-1 gap-12 p-8 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {reviews.map((review, index) => (
                    ...
                    >
                        ...
                        <div className="max-w-80 w-fit h-fit m-auto bg-creme1 text-2xl p-12 rounded-xl">
