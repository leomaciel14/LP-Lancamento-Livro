    ...
    return (
        <div className="relative sm:mb-0 mb-24">
            <div>
                ...
                <div className="absolute -z-10 hidden xl:brightness-100 md:brightness-50 md:block">
                    <img
                        className="min-h-[1024px] xl:min-h-[740px] max-h-[800px] object-cover"
            ...
            <div className="flex flex-col-reverse items-center pt-40 p-6 md:p-12 md:pt-40 lg:p-32 lg:pt-40 lg:flex-row text-left">
                <div className="lg:w-1/2">
                    <h1 className="font-serif text-branco sm:text-7xl lg:text-7xl">
                        Relatos de um <br /> Vampiro na Guerra
                    </h1>
                    <p className="text-branco mt-4 lg:mt-6 text-sm lg:text-base">
                ...
                <img
                    className="w-4/5 sm:w-3/5 max-w-[550px] h-auto mb-4 lg:ml-12"
